        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    StartApplyDocuments = table.Column<DateTime>(nullable: false),
                    EndApplyDocuments = table.Column<DateTime>(nullable: false),
                    StartEnrollment = table.Column<DateTime>(nullable: false),
                    EndEnrollment = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MothersPhoneNumber = table.Column<string>(nullable: true),
                    MothersEGN = table.Column<string>(nullable: true),
                    FathersFullName = table.Column<string>(nullable: true),
                    FathersPhoneNumber = table.Column<string>(nullable: true),
                    FathersEGN = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Criterias_CriteriaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUserClaims_AspNetUsers_SystemUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUserLogins_AspNetUsers_SystemUserId",
                        column: x => x.SystemUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NecessaryDocumentId = table.Column<int>(nullable: false),
                    NumberOfClasses = table.Column<int>(nullable: false),
                    StudentsPerClass = table.Column<int>(nullable: false),
                    SystemUserId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Schools_Procedures_ProcedureId",
                        column: x => x.ProcedureId,
                        principalTable: "Procedures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Schools_AspNetUsers_SystemUserId",
                        column: x => x.SystemUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DocumentSubmissions_AspNetUsers_CandidateId",
                        column: x => x.CandidateId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DocumentSubmissions_Schools_SchoolId",
                        column: x => x.SchoolId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUserClaims_SystemUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUserLogins_SystemUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_CriteriaId",
                table: "AspNetUsers",
                column: "CriteriaId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentSubmissions_CandidateId",
                table: "DocumentSubmissions",
                column: "CandidateId");

            migrationBuilder.CreateIndex(
                name: "IX_DocumentSubmissions_SchoolId",
                table: "DocumentSubmissions",
                column: "SchoolId");
