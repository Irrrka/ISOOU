        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedOn = table.Column<DateTime>(nullable: false),
                    ModifiedOn = table.Column<DateTime>(nullable: true),
                    PermanentCity = table.Column<int>(nullable: false),
                    CurrentCity = table.Column<int>(nullable: false),
                    Permanent = table.Column<string>(nullable: true),
                    Current = table.Column<string>(nullable: true),
                    CurrentDistrictId = table.Column<int>(nullable: false),
                    PermanentDistrictId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Addresses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Addresses_Districts_CurrentDistrictId",
                        column: x => x.CurrentDistrictId,
                        principalTable: "Districts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Addresses_Districts_PermanentDistrictId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Questions_AspNetUsers_SystemUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkDistrictId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Parents_Districts_WorkDistrictId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RankingDate = table.Column<DateTime>(nullable: true),
                    StartApplyDocuments = table.Column<DateTime>(nullable: true),
                    EndApplyDocuments = table.Column<DateTime>(nullable: true),
                    StartEnrollment = table.Column<DateTime>(nullable: true),
                    EndEnrollment = table.Column<DateTime>(nullable: true),
                    Status = table.Column<int>(nullable: false),
                    SchoolID = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdmissionProcedures", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AdmissionProcedures_Schools_SchoolID",
                        column: x => x.SchoolID,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KinderGarten = table.Column<string>(nullable: true),
                    SEN = table.Column<bool>(nullable: false),
                    Desease = table.Column<bool>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Candidates_Parents_FatherId",
                        column: x => x.FatherId,
                        principalTable: "Parents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Candidates_Parents_MotherId",
                        column: x => x.MotherId,
                        principalTable: "Parents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CandidateParents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CandidateParents_Candidates_CandidateId",
                        column: x => x.CandidateId,
                        principalTable: "Candidates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CandidateParents_Parents_ParentId",
                        column: x => x.ParentId,
                        principalTable: "Parents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Criterias_Candidates_CandidateId",
                        column: x => x.CandidateId,
                        principalTable: "Candidates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Addresses_CurrentDistrictId",
                table: "Addresses",
                column: "CurrentDistrictId");

            migrationBuilder.CreateIndex(
                name: "IX_Addresses_PermanentDistrictId",
                table: "Addresses",
                column: "PermanentDistrictId");

            migrationBuilder.CreateIndex(
                name: "IX_AdmissionProcedures_SchoolID",
                table: "AdmissionProcedures",
                column: "SchoolID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CandidateParents_CandidateId",
                table: "CandidateParents",
                column: "CandidateId");

            migrationBuilder.CreateIndex(
                name: "IX_CandidateParents_ParentId",
                table: "CandidateParents",
                column: "ParentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Parents_WorkDistrictId",
                table: "Parents",
                column: "WorkDistrictId");

            migrationBuilder.CreateIndex(
                name: "IX_Questions_SystemUserId",
                table: "Questions",
                column: "SystemUserId");
